...
const CommentBox = ({ selectedBlog }) => {
    ...
    useEffect(() => {
        const getAllCommentsOfBlog = async () => {
            try {
                // eslint-disable-next-line react/prop-types
                const res = await axios.get(`https://mern-blog-1-xmci.onrender.com/api/v1/comment/${selectedBlog._id}/comment/all`)
    ...
    const commentHandler = async () => {
        try {
            const res = await axios.post(
                // eslint-disable-next-line react/prop-types
                `https://mern-blog-1-xmci.onrender.com/api/v1/comment/${selectedBlog._id}/create`,
                { content },
                {
    ...
    const replyHandler = async (commentId) => {
        try {
            const res = await axios.post(
                `https://mern-blog-1-xmci.onrender.com/api/v1/comment/${commentId}/reply`,
                { content: replyText },
                {
                    headers: { "Content-Type": "application/json" },
                    withCredentials: true
    ...
    const deleteComment = async (commentId) => {
        try {
            const res = await axios.delete(`https://mern-blog-1-xmci.onrender.com/api/v1/comment/${commentId}/delete`, {
                withCredentials: true
            })
            if (res.data.success) {
    ...
    const editCommentHandler = async (commentId) => {
        try {
            const res = await axios.put(
                `https://mern-blog-1-xmci.onrender.com/api/v1/comment/${commentId}/edit`,
    ...
    const likeCommentHandler = async (commentId) => {
        try {
            const res = await axios.get(
                `https://mern-blog-1-xmci.onrender.com/api/v1/comment/${commentId}/like`,
                { withCredentials: true }
            );
