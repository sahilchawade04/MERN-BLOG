...
const UpdateBlog = () => {
    ...
    const updateBlogHandler = async () => {
        ...
        try {
            setLoading(true)
            const res = await axios.put(`https://mern-blog-1-xmci.onrender.com/api/v1/blog/${id}`, formData, {
                headers: {
    ...
    const togglePublishUnpublish = async (action) => {
        ...
        try {
            const res = await axios.patch(`https://mern-blog-1-xmci.onrender.com/api/v1/blog/${id}`, {
                params: {
                    action
                },
                withCredentials: true
    ...
    const deleteBlog = async () => {
        try {
            const res = await axios.delete(`https://mern-blog-1-xmci.onrender.com/api/v1/blog/delete/${id}`, { withCredentials: true })
            if (res.data.success) {
            ...
            <div className='max-w-6xl mx-auto mt-8'>
                <Card className="w-full bg-white dark:bg-gray-800 p-5 space-y-2">
                    ...
                    <div className="space-x-2">
                        ...
                        >
                            {selectBlog?.isPublished ? "UnPublish" : "Publish Blog"}
                        </Button>
